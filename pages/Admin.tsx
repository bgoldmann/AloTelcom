...
import { 
  ...
  Users, ShoppingBag, MoreHorizontal, Trash2, Ban, CheckCircle2, Filter
} from 'lucide-react';
import { useApp } from '../store';
import { User, Order } from '../types';

type AdminTab = 'dashboard' | 'users' | 'orders' | 'integrations' | 'seo' | 'theme';
...
const Admin: React.FC = () => {
  ...
  const [orderFilter, setOrderFilter] = useState<'all' | 'active' | 'expired'>('all');
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 pt-20 md:pt-24 max-w-7xl">
        ...
        <div className="animate-fade-in-up">
          <div className="flex justify-between items-center mb-8">
            ...
            {['integrations', 'seo', 'theme', 'dashboard'].includes(activeTab) && (
              <button
                onClick={handleSave}
                disabled={isSaving}

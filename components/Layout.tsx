            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              {user ? (
                <div className="relative pl-4 border-l border-gray-200 dark:border-stone-700">
                 ...
                 <Link to="/dashboard" className="text-sm font-bold text-white bg-pars-primary px-6 py-2.5 rounded-full hover:bg-pars-cta transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                   Login
                 </Link>
              )}
            </div>
          ...
          <div className="md:hidden absolute top-full left-0 w-full bg-white dark:bg-stone-900 border-b border-gray-100 dark:border-stone-800 shadow-xl animate-fade-in">
            <div className="px-4 py-6 space-y-3">
              ...
              {user ? (
                ...
                <Link to="/dashboard" onClick={() => setIsMenuOpen(false)} className="block text-center px-4 py-3 text-base font-bold text-white bg-pars-primary rounded-xl shadow-lg">
                  Login / Sign Up
                </Link>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/support" className="text-sm text-gray-500 dark:text-gray-400 hover:text-pars-cta transition-colors">Help Center</Link></li>
              </ul>
            </div>
